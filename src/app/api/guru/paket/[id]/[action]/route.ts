...
// Essay pasangan (mapel+kelas sama, masih DRAFT/DITOLAK, minimal 1 soal)
// SEBELUM guru benar-benar menekan "Kirim" — supaya bisa ditampilkan popup
// konfirmasi "kirim sekaligus atau PG saja?" hanya kalau memang relevan.
...
export async function POST(
  ...
  if (action === 'kirim') {
    ...
    // ikut mengirim paket Essay pasangan sekaligus. Defaultnya true supaya
