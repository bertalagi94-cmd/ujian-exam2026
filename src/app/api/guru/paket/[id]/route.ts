...
// FIX (kunci bank soal): frontend (src/app/guru/paket/page.tsx) sudah lama
// memanggil DELETE /api/guru/paket/{id} untuk menghapus paket PG, tapi
// handler-nya belum pernah ada di sini (hanya ada di paket-essay). Ditambah
// sekarang, meniru pola yang sama persis dengan
// guru/paket-essay/[id]/route.ts, termasuk pengecekan sesi ujian di bawah.
export async function DELETE(
  ...
  // Cegah menghapus paket PG untuk mapel+kelas yang sesi ujiannya sudah
...
// FITUR BARU: guru bisa mengubah `mode_jawaban` (DIGITAL/KERTAS) paket PG
// setelah dibuat, dengan aturan:
